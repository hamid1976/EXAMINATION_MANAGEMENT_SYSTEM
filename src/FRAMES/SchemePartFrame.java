...
public class SchemePartFrame extends javax.swing.JFrame {
    ...
    private void clear(){
     ...
     private void addRecord(){
      ...
      private void updateRecord(){
        ...
        try {
            //String schemePart =(String) schemePartComboBox.getSelectedItem();
        //int sp =Integer.parseInt(schemePart); 
        String remarks = remarksTextArea.getText();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(-360, 0, 1920, 40));
        ...
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(930, 50, 450, 50));
